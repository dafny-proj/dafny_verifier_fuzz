...
public partial class ASTTranslator {
  ...
  private TypeUnaryExpr TranslateTypeUnaryExpr(Dafny.TypeUnaryExpr te) {
    var e = TranslateExpression(te.E);
    var t = TranslateType(te.ToType);
    return te switch {
      Dafny.ConversionExpr => new TypeConversionExpr(e, t),
      Dafny.TypeTestExpr => new TypeCheckExpr(e, t),
      _ => throw new UnsupportedTranslationException(te),
    };
  }
